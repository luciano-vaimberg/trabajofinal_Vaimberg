...
from .views import agregarAvatar, editarPerfil, register, login_request, editarEmpleados, editarSociosSemiPlenos, editarSociosPlenos, eliminarEmpleados, eliminarSociosSemiPlenos, eliminarSociosPlenos, leerEmpleados, leerSociosSemiPlenos, leerSociosPlenos, busquedaEmpleados, buscarEmpleados,buscarSocioSemiPleno, busquedaSocioSemiPleno ,busquedaSocioPleno, inicio, sociosemipleno, sociopleno, empleado, plenoform, semiplenoform, empleadosform, buscarSocioPleno
